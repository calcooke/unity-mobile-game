    ...
    public class highscoreHandler : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            FirebaseApp.CheckAndFixDependenciesAsync().ContinueWith(task =>
            {
                ...
                {
                    InitializeFirebase();  //Sets the database url and starts listener
                }
                else
                {
                    Debug.LogError(
        ...
        protected virtual void InitializeFirebase()
        {
            ...
            app.SetEditorDatabaseUrl("https://rmp-2018.firebaseio.com/");
                  ...
                  if (e2.Snapshot != null && e2.Snapshot.ChildrenCount > 0)
                  {
                    ...
                    || childSnapshot.Child("score").Value == null)
                        ...
                        childSnapshot.Child("score").Value.ToString());
                              ...
                              highScores.text = "";  //set highscores to blank
        ...
        {
            score = Int32.Parse(scoreText.text); //Needs to be parsed into numbers seeing as it expects an int
            if (score == 0)
            {
